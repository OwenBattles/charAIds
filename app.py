...
def generate_list():
    ...
    prompt = f"Make a heads-up game with {count} unique singular nouns from category: {category}. Use the least amount of description possible. The items should be in a random order. Return them with every entry on a new line and no other text at all."
